...
function dhtmlXTreeObject(htmlObject, width, height, rootId) {
    ...
    this.checkArray = ["iconUncheckAll.gif", "iconCheckAll.gif", "iconCheckGray.gif", "iconUncheckDis.gif", "iconCheckDis.gif", "iconCheckDis.gif"];
    this.radioArray = ["radio_off.gif", "radio_on.gif", "radio_on.gif", "radio_off.gif", "radio_on.gif", "radio_on.gif"];

    this.lineArray = ["line2.gif", "line3.gif", "line4.gif", "blank.gif", "blank.gif", "line1.gif"];
...
dhtmlXTreeObject.prototype._doContClick = function (ev, force) {
    ...
    if (this._acMenu) {
        ...
        if (this._acMenu.showContextMenu) {
            ...
            var corrector = [(dEl0.scrollLeft || dEl1.scrollLeft), (dEl0.scrollTop || dEl1.scrollTop)];
            if (_isIE) {
...
function dhtmlXTreeItemObject(itemId, itemText, parentObject, treeObject, actionHandler, mode) {
    ...
    this.images = [treeObject.imageArray[0], treeObject.imageArray[1], treeObject.imageArray[2]];
...
//#multiselect:01112006{
    ...
    else if ((!node.i_sel) && ((!this._amselS) || (this._selected.length == 0) || (this._selected[0].parentObject == node.parentObject)))
...
dhtmlXTreeObject.prototype.updateItem = function (itemId, name, im0, im1, im2, achecked, child) {
    ...
    sNode.images = [im0 || this.imageArray[0], im1 || this.imageArray[1], im2 || this.imageArray[2]];
