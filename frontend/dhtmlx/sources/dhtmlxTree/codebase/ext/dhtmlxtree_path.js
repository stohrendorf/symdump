...
dhtmlXTreeObject.prototype.activatePaths = function (height) {
    ...
    this.attachEvent("onXLE", function (xml) {
        ...
        for (var i = 0; i < starts.length; i++) {
            ...
            this.addPath(start.parentNode.getAttribute("id"), end.getAttribute("id"), {
                color: start.getAttribute("color"),
                mode: start.getAttribute("mode"),
                width: start.getAttribute("width")
