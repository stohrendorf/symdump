...
dhtmlXCellObject.prototype._detachURLEvents = function (fr) {
    ...
    if (typeof (window.addEventListener) == "function") {
        ...
        } catch (e) {/* console.log("error: url detach mousedown event fail"); */
        }
    } else {
        fr.onreadystatechange = null;
        try {
            fr.contentWindow.document.body.detachEvent("onmousedown", this._doOnFrameMouseDown);
        } catch (e) {
        }
    }
    fr = null;
...
dhtmlXCellTop.prototype.attachStatusBar = function (conf) { // arg-optional, new in version
    ...
    this.dataNodes.sbObj.onselectstart = function (e) {
        return false;
    };
