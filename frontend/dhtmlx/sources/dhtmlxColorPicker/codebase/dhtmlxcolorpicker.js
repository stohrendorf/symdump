...
dhtmlXColorPicker.prototype._refreshContrast = function () {
    ...
    if (ieV && ieV <= 9) {
        ...
        var hex_bot = this.colorAIP.rgb2hex({
            r: Math.round(255 * rgb_top.r),
            g: Math.round(255 * rgb_top.g),
            b: Math.round(255 * rgb_top.b)
        });
        var hex_top = this.colorAIP.rgb2hex({
            r: Math.round(255 * rgb_bot.r),
            g: Math.round(255 * rgb_bot.g),
            b: Math.round(255 * rgb_bot.b)
        });
