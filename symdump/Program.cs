...
namespace symdump
{
    internal class Program
    {
        ...
        private static void dumpEntry(FileStream fs)
        {
            //Console.WriteLine($"@{fs.Position:X}  ");
        ...
        private static void dumpType20(FileStream fs, uint offset)
        {
        ...
        private static void dumpType22(FileStream fs, uint offset)
        {
            var classx = fs.readClassType();
            var typex = fs.readTypeDef();
            var size = fs.ReadU4();
