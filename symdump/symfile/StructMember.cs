...
namespace symfile
{
    public class StructMember : IEquatable<StructMember>
    {
        ...
        public StructMember(TypedValue tv, BinaryReader reader, bool extended)
        {
            ...
            if(typeInfo.classType != ClassType.Bitfield && typeInfo.classType != ClassType.StructMember && typeInfo.classType != ClassType.UnionMember && typeInfo.classType != ClassType.EndOfStruct)
        ...
        public bool Equals(StructMember other)
        {
            ...
            return string.Equals(name, other.name) && typeInfo.Equals(other.typeInfo) && typedValue.Equals(other.typedValue);
        }
